...
public class DataHelper {
    ...
    public static YearInfo getSpecialSimbolsYearInfo() {
        return new YearInfo("!(*&");
    }
    ...
    public static OwnerInfo generateOwner(String locale) {
        Faker faker = new Faker(new Locale(locale));
        var fakerOwner = faker.name().firstName() + "" + faker.name().firstName();
    ...
    public static CvcInfo getSpecialsSymbolsCvcCode() {
        return new CvcInfo("$$#");
    }
